...
$(KERNEL): $(BUILD_DIR)/multiboot.o $(BUILD_DIR)/interrupts.o \
           ...
           $(BUILD_DIR)/string.o $(BUILD_DIR)/shell.o $(BUILD_DIR)/syscall.o \
           $(BUILD_DIR)/net.o $(BUILD_DIR)/arp.o $(BUILD_DIR)/ip.o \
           $(BUILD_DIR)/icmp.o $(BUILD_DIR)/udp.o $(BUILD_DIR)/tcp.o \
$(BUILD_DIR)/netdrv.o $(BUILD_DIR)/socket.o $(BUILD_DIR)/netcmd.o $(BUILD_DIR)/http.o $(BUILD_DIR)/dns.o $(BUILD_DIR)/dhcp.o $(BUILD_DIR)/http_client.o
	$(LD) $(LDFLAGS) -o $@ $^
